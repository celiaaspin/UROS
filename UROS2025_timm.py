#pip install torch torchvision torchaudio scikit-learn matplotlib pillow seaborn numpy timm
        ...
        for phase in ['train', 'validation']:
            ...
            if phase == 'train':
                ...
                if epoch_loss < best_loss:
                    ...
                    early_stop_counter = 0
                    torch.save(model.state_dict(), 'models/pytorch/timm_multi_ALL.h5')
                    print(f"New best model saved with loss: {best_loss:.4f}")
                else:
                    early_stop_counter += 1
                    if early_stop_counter >= patience:
                        print("Early stopping triggered.")
                        model.load_state_dict(torch.load('models/pytorch/timm_multi_ALL.h5'))
...
model_path = 'models/pytorch/timm_multi_ALL.h5'
